...
# @Editor: Kcenia Bougrova
# @Edit_Date: 2022-12-28
import logging
import os
...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings, debug=False, fmake=True):
        ...
        #KB 28-December-2022 
        self.IS_MOCK = user.ask_is_mock()  # Change to False if mock has its own task
        ...
        if self.IS_MOCK:
            ...
            self.SESSION_IDX = user.ask_confirm_session_idx(self.SESSION_IDX)
        ...
        # ROTARY ENCODER
        # =====================================================================
        self.STIM_POSITIONS = [-35, 35]  # All possible positions (deg) #KB
        self.QUIESCENCE_THRESHOLDS = [-2, 2]  # degree #KB
...
if __name__ == "__main__":
    ...
    _user_settings.PYBPOD_PROTOCOL = "_iblrig_tasks_biasedChoiceWorld_ephyssessions"
    if platform == "linux":
