...
for i in range(sph.NTRIALS):  # Main loop
    ...
    sma.add_state(
        ...
        state_change_conditions={
            "Tup": "interactive_delay_2",                   #changed
            tph.event_error: "interactive_delay_3",         #changed
            tph.event_reward: "interactive_delay_4",        #changed 
        },
    )
    ##################added###################
    sma.add_state(
        state_name="interactive_delay_2",
        state_timer=tph.interactive_delay_2, #change in the other file
    ...
    ##################added###################
    sma.add_state(
        state_name="interactive_delay_4",
        state_timer=tph.interactive_delay_2, #change in the other file
