...
INTERACTIVE_DELAY_2 = 1  # (s) how long after stim onset the CL starts #added
INTERACTIVE_DELAY_3 = 1  # (s) how long after stim onset the CL starts #added Mar232022 KB
...
CONTRAST_SET = [1., 0.25, 0.09, 0.]  # Full contrast set
