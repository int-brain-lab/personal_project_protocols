...
class TrialParamHandler(object):
    ...
    def __init__(self, sph):
        ...
        self.interactive_delay_2 = sph.INTERACTIVE_DELAY_2 #added kb Jan282022
        self.interactive_delay_3 = sph.INTERACTIVE_DELAY_3 #added kb Mar232022
...
if __name__ == '__main__':
    ...
    _user_settings.PYBPOD_PROTOCOL = '_iblrig_tasks_biasedChoiceWorld_RPE_Mar23bah'
    if platform == 'linux':
