...
# =============================================================================
    ...
    sma.add_state(
        ...
        output_actions=[('Serial1', re_show_stim),("BNC1",255)])
    ...
    sma.add_state(
        ...
        state_timer=0,
        #state_change_conditions={'Tup': 'closed_loop'}, #commented
        state_change_conditions={'Tup': 'closed_loop'}, #added
        output_actions=[('Serial1', re_reset)])
    ...
    sma.add_state(
        ...
        state_change_conditions={'Tup': 'no_go',
                                 tph.event_error: 'interactive_delay_3',
                                 tph.event_reward: 'interactive_delay_2'},
        output_actions=[('Serial1', re_close_loop)]) 


#    sma.add_state( #added KB Jan282022
#        state_name='interactive_delay_2',
#        state_timer=tph.interactive_delay_2,
...
#        output_actions=[])
    ...
    sma.add_state( #added KB Mar232022
        state_name='interactive_delay_3',
        state_timer=tph.interactive_delay_3,
