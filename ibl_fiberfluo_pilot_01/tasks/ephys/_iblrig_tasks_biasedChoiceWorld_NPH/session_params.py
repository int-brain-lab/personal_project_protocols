...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings, debug=False, fmake=True):
        ...
        self.CONTRAST_SET = [1.0, 0.25, 0.1, 0.0]  # KB 21032022 # Full contrast set 
...
if __name__ == "__main__":
    ...
    _user_settings.PYBPOD_SETUP = "biasedChoiceWorld_NPH"
    _user_settings.PYBPOD_PROTOCOL = "_iblrig_tasks_biasedChoiceWorld_NPH"
    if platform == "linux":
