...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings, debug=False, fmake=True):
        ...
        self.VISUAL_STIMULUS_FILE = r"C:\personal_project_protocols\carandiniharris_midbrain_ibl\visual_stim\GaborIBLTask\Gabor2D.bonsai"
        self.VISUAL_STIMULUS_FOLDER = (
            r"C:\personal_project_protocols\carandiniharris_midbrain_ibl\visual_stim"
        )
