...
# TASK
NTRIALS = 150  # Number of trials for the current session
USE_AUTOMATIC_STOPPING_CRITERIONS = (
    False  # Weather to check for the Automatic stopping criterions or not  # noqa
)
...
RESPONSE_WINDOW = 3  # Time to move the wheel after go tone (seconds)
...
# CONTRASTS
CONTRAST_SET = [0.0]  # Full contrast set
