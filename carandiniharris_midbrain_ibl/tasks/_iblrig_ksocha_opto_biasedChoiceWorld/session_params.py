...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings, debug=False, fmake=True):
        ...
        #self.laser_probability=0.3

        self.prestimulus_time_laser=int(self.PRESTIMULUS_TIME_LASER)

        self.laser_stimulation_where=self.LASER_STIMULATION_WHERE

        self.probability_laser_stimulation_where=self.PROBABILITY_LASER_STIMULATION_WHERE
        # =====================================================================
