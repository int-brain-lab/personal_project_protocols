...
RESPONSE_WINDOW = 20  # Time to move the wheel after go tone (seconds)
...
BLOCK_PROBABILITY_SET = [0.2, 0.8] #0.2 0.8
BLOCK_LEN_FACTOR = 60
BLOCK_LEN_MIN = 20
BLOCK_LEN_MAX = 100
# LASER
...
LASER_PROB_0_STIM = 0.7 #0.7  # Probability of laser stimulation during stimulated blocks in 0% contrast trials
LASER_PROB_0_NOSTIM = 0.2 #0.2  # Probability of laser stimulation during non-stimulated blocks in 0% contrast trials
