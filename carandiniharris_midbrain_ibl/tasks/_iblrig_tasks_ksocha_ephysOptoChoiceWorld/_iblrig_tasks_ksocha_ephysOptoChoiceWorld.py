...
for i in range(sph.NTRIALS):  # Main loop
    ...
    if i == 0:  # First trial exception start camera
        ...
        sma.add_state(
            state_name="trial_start",
            state_timer=0.3,  # ~100µs hardware irreducible delay
    ...
    sma.add_state(
        state_name="quiescent_laser_period",
        state_timer=0,
        output_actions=[tph.laser_out_quiescence],
        state_change_conditions={
            "Tup": "stim_on",
        },
    )
    ...
    sma.add_state(
        state_name="stim_on",
        state_timer=0.1,
        output_actions=[("Serial1", bonsai_show_stim),tph.laser_out_stimulus],
        state_change_conditions={
    ...
    sma.add_state(
        ...
        state_timer=0.05,
        output_actions=[tph.out_tone, tph.laser_out_go_cue],
        state_change_conditions={
    ...
    sma.add_state(
        ...
        state_timer=0.5,
        output_actions=[("BNC1", 255), tph.laser_out_iti],
