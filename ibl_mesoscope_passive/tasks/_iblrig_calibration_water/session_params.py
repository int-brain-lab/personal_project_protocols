...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings):
        ...
        self.CALIBRATION_FUNCTION_FILE_PATH = os.path.join(
            self.SESSION_RAW_DATA_FOLDER, "_iblrig_calibration_water_function.csv"
        )
        self.CALIBRATION_RANGE_FILE_PATH = os.path.join(
            self.SESSION_RAW_DATA_FOLDER, "_iblrig_calibration_water_range.csv"
        )
        self.CALIBRATION_CURVE_FILE_PATH = os.path.join(
            self.SESSION_RAW_DATA_FOLDER, "_iblrig_calibration_water_curve.pdf"
        )
